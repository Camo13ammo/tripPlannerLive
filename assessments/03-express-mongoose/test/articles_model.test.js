...
describe('Articles', function () {
    ...
    it('requires content', function (done) {
    ...
    it('has lastUpdatedAt field that is originally the time at creation', function (done) {
     ...
     */
    it('has a virtual 23-character snippet field appended with "..."', function (done) {
     ...
     */
    it('has an instance method to truncate the content', function (done) {
    ...
    it('content truncation accepts any length', function (done) {
    ...
    it('static method findByTitle can work with vanilla callbacks', function (done) {
    ...
    it('static method findByTitle can work with promise style', function (done) {
    ...
    it('recalculates lastUpdatedAt field before every save', function (done) {
